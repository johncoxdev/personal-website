          ...
          <li>
            <Link href="/">
              <span className="cursor-custom group text-white transition-all duration-500 ease-in-out mx-6">
                <span className="bg-left-bottom bg-gradient-to-r from-babyblue to-purple bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-350 ease-out">
                  Home
                </span>
              </span>
            </Link>
